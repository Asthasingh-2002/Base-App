    ...
    <div className="flex flex-col justify-start m-10  w-96 ">
      ...
      <div className="bg-white rounded-lg w-50 p-5">
        ...
        <div className=" text-sm flex flex-col m-2 " >
          ...
          <input  className="bg-gray-200  rounded-md p-1 mt-1" type="password" />
        </div>
          <h1 className="text-blue-500 m-2 text-sm">Forgot password?</h1>
          <button className="bg-[#605BFF] w-full m-2 text-sm text-white  rounded-md p-1 font-semibold" type="submit ">Sign In</button>
        </form>
      </div>
      <h1 className="text-center text-sm m-5 text-[#858585]">Don’t have an account? <span className="text-[#346BD4]" >Register here</span></h1>
    </div>
  );
}
